...
export class CreateComponent {
  ...
  get visible() {
    return this.sucursalStore.isOpenCreate();
  }

  onHide() {
    this.sucursalStore.closeModalCreate();
    this.sucursalForm.reset({ nombre: '', direccion: ''}); // Resetear formulario
    this.sucursalForm.markAsUntouched(); // Limpiar estado touched
  }
  ...
  onSubmit() {
    ...
    if (this.sucursalForm.valid) {
      ...
      this.sucursalStore.doCreate(formData);
